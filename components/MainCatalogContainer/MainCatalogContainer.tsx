...
Мы всегда поможем вам подобрать букет для вашего события, наш менеджер вас проконсультирует и поможет определиться с выбором</p>
        ...
        <div className={styles.container1}><MainCatalogLandingFields prop={firstCatalog}></MainCatalogLandingFields></div>
        <div className={styles.container2}><MainCatalogLandingFields prop={secondCatalog}></MainCatalogLandingFields></div>
        <div className={styles.container3}><MainCatalogLandingFields prop={thirdCatalog}></MainCatalogLandingFields></div>
